...
public class StockprojectApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Product p1 = new Product(1L, "TV", "Un", 2200.00, cat1);
		Product p2 = new Product(2L, "Domain Driven Design", "Un", 120.00, cat2);
		Product p3 = new Product(3L, "PS5", "Un", 2800.00, cat1);
		Product p4 = new Product(4L, "Docker", "Un", 100.00, cat2);
